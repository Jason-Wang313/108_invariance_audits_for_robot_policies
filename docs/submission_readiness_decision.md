...
Honest strongest claim: `Audit which policy invariances are physically valid and which erase necessary distinctions.` is a plausible branch-structured mechanism for robot policy evaluation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
