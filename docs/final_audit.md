...
1. Chosen thesis: Invariance Audits for Robot Policies explores `Audit which policy invariances are physically valid and which erase necessary distinctions.` for robot policy evaluation.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/108.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/108_invariance_audits_for_robot_policies
